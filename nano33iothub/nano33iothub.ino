...
void publishMessage() {
  ...
  int userId = 7;
  String date = "2022-02-11 2:41:34.000";
  String exercise = "device talking to iot";
  String data = "161.81, -0.27, -0.96, -0.01, 0.44, 0.22, 0.03, 55.36, 6.90, 17.85, -74.07, -0.23, -0.99, -0.05, 0.31, 1.04, -0.18, 55.51, 5.70, 17.40, -76.45, 13.27,";
  doc["userId"] = userId;
